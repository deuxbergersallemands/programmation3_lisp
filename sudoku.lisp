...
(defun verifier-grille-rempli (grille)
   ...
   (if (zerop *drapeau-rempli* )
	(progn(format t "La grille est enti̬rement remplie !~%") (verifier-solution grille *grille-solution*))
       (format t "La grille n'est pas enti̬rement remplie !~%"))
  )
...
(defun verifier-solution(grille solution)
   ...
   (if (/= *drapeau* 1)
      ...
      (format t "Vous n'avez pas la bonne solution! Trouvez votre erreur pour gagn̩ !~%")
   ))
